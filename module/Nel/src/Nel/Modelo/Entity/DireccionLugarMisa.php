...
class DireccionLugarMisa extends TableGateway
{
    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null)
    {
        return parent::__construct('direccionlugarmisa', $adapter, $databaseSchema, $selectResultPrototype);
    }
...
//        return $resultado;
//    }
    public function FiltrarDireccionLugarMisaPorLugarEstado($idLugarMisa,$estado){
        $resultado = $this->getAdapter()->query("CALL Sp_FiltrarDireccionLugarMisaPorLugarEstado('{$idLugarMisa}','{$estado}')", Adapter::QUERY_MODE_EXECUTE)->toArray();
        return $resultado;
    }
    public function IngresarDireccionLugarMisa($idLugarMisa,$idConfigurarParroquiaCanton,$direccionLugarMisa,$referenciaLugarMisa,$fechaIngresoDireccionMisa,$estadoDireccionLugarMisa)
    {
        $resultado =  $this->getAdapter()->query("CALL Sp_IngresarDireccionLugarMisa('{$idLugarMisa}','{$idConfigurarParroquiaCanton}','{$direccionLugarMisa}','{$referenciaLugarMisa}','{$fechaIngresoDireccionMisa}','{$estadoDireccionLugarMisa}')", Adapter::QUERY_MODE_EXECUTE)->toArray();
        return $resultado;
    }
