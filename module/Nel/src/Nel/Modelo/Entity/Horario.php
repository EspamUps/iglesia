...
class Horario extends TableGateway
{
    ...
    {
        return parent::__construct('horario', $adapter, $databaseSchema, $selectResultPrototype);
    }
...
//    }
    ...
    public function FiltrarHorarioPorCurso($idCurso){
        $resultado = $this->getAdapter()->query("CALL Sp_FiltrarHorarioPorCurso('{$idCurso}')", Adapter::QUERY_MODE_EXECUTE)->toArray();
        return $resultado;
    }
////    
